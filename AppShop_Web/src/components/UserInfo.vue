    ...
    <el-main style="height: 100vh; background: rgb(255,255,255); padding: 0; z-index: 8">
      ...
      <div style="margin: 15px auto; width: 50%; display: flex; flex-direction: column; align-items: center;">
        ...
        <div class="name" style="margin-bottom: 15px; width: 100%;">
          ...
          <el-input v-model="form.userName" placeholder="NULL"
        ...
        <div class="petname" style="margin-bottom: 15px; width: 100%;">
          ...
          <el-input v-model="form.petName" placeholder="NULL"
            style="font-family: 'MiSans'; font-weight: lighter; height: 35px; width: 100%;"></el-input>
        </div>
        ...
        <div class="corp" style="margin-bottom: 15px; width: 100%;">
          ...
          <el-input disabled v-model="form.crop" placeholder="NULL"
            style="font-family: 'MiSans'; font-weight: lighter; height: 35px; width: 100%;"></el-input>
        </div>
        <hr style="width: 100%;" />
        <div class="addbutton">
          <el-button style="width: 100px; font-family: 'MiSans';" @click="cancel">返回</el-button>
          <el-button type="primary" style="width: 100px; font-family: 'MiSans';" @click="update">更新信息</el-button>
          <el-button type="primary" style="width: 100px; font-family: 'MiSans';" @click="password">更改密码</el-button>
        </div>
      </div>
    </el-main>
  </el-container>
...
axios.post(`/api/userInfo?telephone=${store.state.id}`,
  {
    // headers: {
    //   'Content-Type': 'application/json',
    //   token: store.state.token,
...
const update = () => {
  if (form.userName == '' || form.petName == '' || newiconURL == '') {
    ElMessage.error('请补全用户信息！')
  } else {
